            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-2 max-w-xl text-sm text-gray-500">
                  <p>
                    Your AI-powered healthcare assistant is ready to help. Start a conversation for general health questions,
                    use the Symptom Checker for structured analysis of multiple symptoms with urgency levels and recommendations,
                    or track your health metrics using the cards above.
                  </p>
                </div>
                <div className="mt-5">
